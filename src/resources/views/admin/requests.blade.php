        ...
        <div class="attendance__result">
            <table class="attendance-table">
                ...
                <tbody class="attendance-table__tbody">
                    @forelse ($attendance_requests as $attendance_request)
                        <tr class="attendance-table__row">
                            ...
                            <td class="attendance-table__item">{{ $attendance_request->user }}</td>
                            <td class="attendance-table__item">{{ $attendance_request->reason }}</td>
                            <td class="attendance-table__item">{{ $attendance_request->status }}</td>
                        </tr>
                    @empty
                        <tr>
